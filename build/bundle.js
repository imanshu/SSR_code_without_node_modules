...
exports.fetchAdmins = exports.FETCH_ADMINS = exports.fetchCurrentUser = exports.FETCH_CURRENT_USER = exports.FETCH_USERS = undefined;
...
function fetchUsers() {
  return function (dispatch) {
    ...
    return _axios2.default.get('https://react-ssr-api.herokuapp.com/users').then(function (res) {
      console.log(res);
      dispatch({
        type: FETCH_USERS,
        payload: res
...
app.get('*', function (req, res) {
  ...
  var initialState = {
    users: [{ "id": 1, "name": "Remi Prasanna" }, { "id": 2, "name": "Ervin Howell" }, { "id": 3, "name": "Clementine Bauch" }, { "id": 4, "name": "Patricia Lebsack" }, { "id": 5, "name": "Chelsey Dietrich" }],
    auth: [],
    admins: []

  };
  var store = (0, _createStore2.default)(req, initialState);
...
exports.default = function (req, initialState) {
